...
st.markdown("""
<style>
    /* Entferne Standard-Padding und Margins */
    ...
    /* Verhindere unsichtbare Deko-/Toolbar-Abstände */
    div[data-testid="stDecoration"],
    div[data-testid="stToolbar"] { display: none !important; height: 0 !important; min-height: 0 !important; }
    .main .block-container {
        ...
        margin-top: -1.2rem !important; /* ziehe gesamten Inhalt nach oben */
    }
    ...
    /* Streamlit Header komplett ausblenden (kein reservierter Platz) */
    ...
    /* Entferne zusätzliche Top-Margins */
    .stApp {
        margin-top: 0rem !important;
        padding-top: 0rem !important;
    }
    
    /* Erste Element-Container nach oben */
    .main .block-container > div:first-child {
        margin-top: -0.6rem !important; /* erster sichtbarer Block bündig */
        padding-top: 0rem !important;
    }
    /* Alle direkten Blöcke kompakt halten */
    div[data-testid="stVerticalBlock"],
    div[data-testid="stHorizontalBlock"] {
        margin-top: 0 !important;
        padding-top: 0 !important;
    }
    /* Element-Container standardmäßig ohne oberen Abstand, speziell den ersten absolut bündig */
    .element-container { margin-top: 0.1rem !important; margin-bottom: 0.3rem !important; padding-top: 0 !important; }
    .element-container:first-child { margin-top: 0 !important; }
    
    /* Tab-Container kompakter */
    ...
    /* Reduziere Abstände zwischen Elementen */
    .element-container {
    ...
    /* Kompaktere Text Areas */
    .stTextArea > label {
        margin-bottom: 0.2rem !important;
    }
    
    /* Reduziere Abstände bei Columns */
    .stColumns {
        gap: 0.5rem !important;
    }
    
    /* Kompaktere Dataframes */
    .stDataFrame {
        margin-bottom: 0.5rem !important;
    }
    
    /* Kompaktere Markdown Elemente */
    .stMarkdown {
        margin-bottom: 0.3rem !important;
    }
    
    /* Kompaktere Info/Warning/Success Boxes */
    .stAlert {
        margin-bottom: 0.5rem !important;
        padding: 0.5rem !important;
    }
    
    /* Kompaktere File Uploader */
    .stFileUploader {
        margin-bottom: 0.5rem !important;
    }
</style>
    ...
    st.markdown(
        ...
        <style>
            @media (max-width: 768px) {{
                .header-flex {{ flex-direction: column; align-items: flex-start; gap: 0.2rem; }}
                .header-title-wrap {{ flex-direction: column; align-items: flex-start; }}
            }}
        </style>
        <div class=\"header-flex\" style=\"display: flex; justify-content: space-between; align-items: center; padding-top: 0rem; padding-bottom: 0rem; margin-top: -0.6rem; margin-bottom: 0rem;\">
        ...
        <hr style=\"margin-top: 0; margin-bottom: 0.1rem; border-top-width: 1px;\">
        """,
        unsafe_allow_html=True,
    )
...
def render_chat_history():
    ...
    with col1:
        ...
        # Kompakte Darstellung wie Tabelle: geringe Abstände, linksbündig, scrollbar
        st.markdown(
            """
            <style>
            .chat-list-scope .stButton > button {
            ...
            .chat-list-scope .stButton > button:hover {
        ...
        st.markdown("<div class='chat-list-scope'>", unsafe_allow_html=True)
        
        # Nur die Frage anzeigen und jede Zeile klickbar machen
        for chat in chat_history:
            ...
            if st.button(display_question, key=f"chat_row_{chat_id}", use_container_width=True):
...
async def main():
    ...
    with tab3:
        ...
        if st.session_state.sources:
            ...
            with col1:
                st.markdown("<h5 style='margin-top: 0rem; margin-bottom: 0.5rem;'>📄 Vorschau</h5>", unsafe_allow_html=True)
            with col2:
                delete_button_pressed = st.button("🗑️ Ausgewähltes Dokument/Notiz löschen", key="delete_doc_button")
