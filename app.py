...
def render_header():
    ...
    st.markdown(
        ...
        <div class=\"header-flex\" style=\"display: flex; justify-content: space-between; align-items: center; padding-top: 0.2rem; padding-bottom: 0.2rem;\">
            <div class=\"header-title-wrap\" style=\"display: flex; align-items: center;\">
                <img src=\"data:image/png;base64,{encoded}\" alt=\"Logo\" style=\"height: 38px; margin-right: 12px;\">
                <span style=\"font-size: 20px; font-weight: 600;\">Wunsch-Öle Wissens Agent</span>
                <span style=\"color: #007BFF; font-size: 13px; margin-left: 10px;\">🔧 Version: {app_version}</span>
            </div>
            <div style=\"font-size: 13px;\">
                📄 Dokumente: {doc_count} &nbsp;&nbsp;&nbsp; 🧠 Notizen: {note_count}
            </div>
        </div>
        <hr style=\"margin-top: 0.2rem; margin-bottom: 0.4rem;\">
        """,
...
async def main():
    ...
    with tab1:
        ...
        with chat_tab1:
            ...
            st.markdown("<h5>💬 Spreche mit dem Wunsch-Öle KI Assistenten</h5>", unsafe_allow_html=True)
    ...
    with tab2:
        ...
        with knowledge_tab1:
            st.markdown("<h5>➕ Wissen hinzufügen</h5>", unsafe_allow_html=True)
            st.markdown(
        ...
        with knowledge_tab2:
            st.markdown(
                """
            <h5>📎 Dateien für Wissensdatenbank hochladen</h5>
